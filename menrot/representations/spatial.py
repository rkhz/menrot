...
from menrot.models import NeuralRenderer
...
class SpatialRep:
    def __init__(self, snapshot_path, device=None):
        ...
        self.model = NeuralRenderer(in_channels=3, pre_activation=True)
    ...
    def __call__(self, x, azimuth=None, rot_angle=None):
        with torch.no_grad():
            ...
            if rot_angle is not None:
                rot_matrix = menrot_F.rotation_matrix_source_to_target(
                ...
                return menrot_F.rotate3d(self.model.encoder(x), rot_matrix)
